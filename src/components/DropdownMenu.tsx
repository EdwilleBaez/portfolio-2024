...
const DropdownMenu = ({ options }: DropdownMenuProps) => {
	...
	return (
		<div className="relative" ref={dropdownRef}>
			...
			{isOpen && (
				<div onClick={() => setIsOpen(false)} className="absolute right-0 mt-2 py-4 w-44 bg-white border border-gray-300 text-center rounded shadow-lg overflow-hidden duration-200">
