...
const handleClick = (e: React.MouseEvent<HTMLAnchorElement>) => {
  ...
  return (
    <nav className={`flex justify-center items-center fixed top-0 w-screen z-10 bg-white font-raleway font-medium content-center transform sm:duration-500 ease-in-out ${scrollDirection === "up" ? 'h-20 sm:h-36' : 'h-10 sm:h-16'}`}>
      <div className="w-4/6">
        ...
        <div className={`max-w-7xl mx-auto transition sm:duration-500 ease-in-out ${scrollDirection === "up" ? 'border-t-[1px] border-black' : ''}`}>
            <div className="w-full h-10 sm:h-16  flex justify-between items-center">
