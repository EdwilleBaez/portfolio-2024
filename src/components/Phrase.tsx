...
const Phrase = () => {
  ...
  return (
    <div>
      <section className="p-10 flex justify-center items-center gap-5 content-center h-screen bg-primary">
        <div className="md:w-1/3 min-w-44  flex flex-col justify-center md:mr-20">
